...
export const hasStoredLanguagePreference = (): boolean => {
...
export const applyHostLocale = (value?: string): SupportedLanguage => {
  ...
  vi: {
    translation: {
      game: {
        ...
        description:
          'Chém đậu phộng, dừa, chuối, thanh long và khế bay lên giữa cánh đồng làng quê. Coi chừng quả bom — một nhát thôi là Lạc Lạc giận đó!',
  ...
  en: {
    translation: {
      game: {
        ...
        description:
          'Slash peanuts, coconuts, bananas, dragon fruits and starfruits flying up in the countryside. Watch out for bombs — one slash and Lac Lac will get angry!',
